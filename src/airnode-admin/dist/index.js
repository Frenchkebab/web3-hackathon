...
exports.updateAuthorizers =
  exports.updateProviderAdmin =
  exports.createProvider =
  exports.checkWithdrawalRequest =
  exports.requestWithdrawal =
  exports.createTemplate =
  exports.unendorseClient =
  exports.endorseClient =
  exports.deriveDesignatedWallet =
  exports.updateRequesterAdmin =
  exports.createRequester =
    void 0;
...
function createRequester(airnode, requesterAdmin) {
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4 /*yield*/, airnode.createRequester(requesterAdmin)];
        case 1:
          receipt = _a.sent();
          return [
            2 /*return*/,
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [
            4 /*yield*/,
            airnode.updateRequesterAdmin(requesterIndex, requesterAdmin),
          ];
        case 1:
          receipt = _a.sent();
          return [
...
function deriveDesignatedWallet(airnode, providerId, requesterIndex) {
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4 /*yield*/, airnode.getProvider(providerId)];
        case 1:
          provider = _a.sent();
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [
            4 /*yield*/,
            airnode.updateClientEndorsementStatus(
              requesterIndex,
              clientAddress,
              true
            ),
...
function requestWithdrawal(airnode, providerId, requesterIndex, destination) {
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          designatedWalletAddress = deriveDesignatedWallet(
            airnode,
            providerId,
            requesterIndex
          );
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [
            4 /*yield*/,
            airnode.provider.getLogs({
              address: airnode.address,
              fromBlock: 0,
              topics: [
                ethers_1.ethers.utils.id(
...
function createProvider(airnode, providerAdmin) {
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          hdNode = ethers_1.ethers.utils.HDNode.fromMnemonic(
            airnode.signer.mnemonic.phrase
          );
          xpub = hdNode.neuter().extendedKey;
          masterWallet = ethers_1.ethers.Wallet.fromMnemonic(
            airnode.signer.mnemonic.phrase,
            'm'
          ).connect(airnode.provider);
          return [
            4 /*yield*/,
            airnode.connect(masterWallet).createProvider(providerAdmin, xpub),
          ];
        case 1:
          receipt = _a.sent();
          return [
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [
            4 /*yield*/,
            airnode.updateProvider(providerId, providerAdmin),
          ];
        case 1:
          receipt = _a.sent();
          return [
...
//           return [
//             4 /*yield*/,
//             airnode.updateEndpointAuthorizers(
//               providerId,
//               endpointId,
//               authorizers
//             ),
...
async function updateAuthorizers(airnode, providerId, endpointId, authorizers) {
