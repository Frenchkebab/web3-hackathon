...
contract AirnodeClient is IAirnodeClient {
    ...
    constructor(address airnodeAddress) public {
    ...
    function airnodeAddress() external view override returns (address _airnodeAddress) {
    ...
    modifier onlyAirnode() {
        require(msg.sender == address(airnode), "Caller not the Airnode contract");
        _;
    }
}
